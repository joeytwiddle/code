...
if (search)
{
	...
	switch (search_type)
	{
		...
		case 'm': // Searches IMDB
			window.location = "http://www.google.com/search?hl=en&q=site%3Aimdb.com+" + search_query + "&btnI=I%27m+Feeling+Lucky";
			break;

		case 'p': // Searches Playlist
			window.location = "http://searchbeta.playlist.com/tracks#" + search_query;
			break;
