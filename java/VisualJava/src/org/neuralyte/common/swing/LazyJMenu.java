 ...
 * <P>
 * This is useful if you want to provide large menu trees but
 * it would be costly to generate all the nodes in advance.
 * <P>
 * A LazyJMenu's child items are generated when they are needed by generateChildren().
 * <P>
 ...
 * <P>
 * (I'm sure Java menu's used to be lazy!)
 * <P>
 * (Thanks to Liu Yang.)
 */

public abstract class LazyJMenu extends JMenu {
