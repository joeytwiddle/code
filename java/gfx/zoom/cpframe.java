...
// cpframe - The frame in which the cyberpet lives
//           an interactive GUI
public class cpframe extends Frame implements ActionListener {
    // Owns one pet
    public octopus octo;
    // AWT components
	...
	cpframe octoframe=new cpframe("Octo the cyber pet!");
	octoframe.show();
    }
    cpframe(String title) {
...
class octopus implements Serializable {
    ...
    octopus(cpframe temp1,int temp2,int temp3) {
...
class mythread extends Thread implements Serializable {
    ...
    mythread(cpframe temp1,octopus temp2,int temp3) {
	cpf=temp1;
	octo=temp2;
	sleeptime=temp3;
    }
...
class animthread extends mythread {
    animthread(cpframe temp1,octopus temp2,int temp3) {
...
class biothread extends mythread {
    biothread(cpframe temp1,octopus temp2,int temp3) {
	super(temp1,temp2,temp3);
    }
    void moment() {
...
class comsthread extends mythread {
    ...
    // Time to show for
    int showfor=0;
    comsthread(cpframe temp1,octopus temp2,int temp3) {
	super(temp1,temp2,temp3);
    }
