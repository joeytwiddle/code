...
/*    public static void main(String argv[]) {
	...
	cpapplet octoframe=new cpapplet("Octo the cyber pet!");
	octoframe.show();
    }*/
/*    cpapplet(String title) {
...
class octopus implements Serializable {
    ...
    octopus(cpapplet temp1,int temp2,int temp3) {
...
class mythread extends Thread implements Serializable {
    ...
    mythread(cpapplet temp1,octopus temp2,int temp3) {
	cpf=temp1;
	octo=temp2;
	sleeptime=temp3;
    }
...
class animthread extends mythread {
    animthread(cpapplet temp1,octopus temp2,int temp3) {
...
class biothread extends mythread {
    biothread(cpapplet temp1,octopus temp2,int temp3) {
	super(temp1,temp2,temp3);
    }
    void moment() {
...
class comsthread extends mythread {
    ...
    // Time to show for
    int showfor=0;
    comsthread(cpapplet temp1,octopus temp2,int temp3) {
	super(temp1,temp2,temp3);
    }
