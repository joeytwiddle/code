...
//    out.print("    // Rendering "+a.type+": "+rs+"\n";
  ...
  public void renderIn(Vector unusedmatches,Type t,String target,PrintStream out) {
	...
	/** At the moment only Arom searching is possible.
	 *  Variable searching could be implemented, or you could make the variable into an atom in the grammar.
	**/

	public Match getUp(String called) {
    if (type instanceof Atom)
      if (((Atom)type).type.equals(called))
        return this;
    if (parent==null)
			return null;
