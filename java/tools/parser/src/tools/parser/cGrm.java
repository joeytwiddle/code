...
public class cGrm extends GrammarHelper {
  public static Grammar setupgrammar() {
    ...
    rule=new Vector<Type>();
        { Vector realrule=rule; rule=new Vector<Type>();  realrule.add(new RelElement('^',"TemplateClass",(Type)rule.get(0))); rule=realrule; }
         rule.add(new Atom("OptTemplate"));
         rule.add(new Atom("OptVarMods"));
         rule.add(new Atom("VarType"));
         rule.add(new Text(" "));
         rule.add(new Atom("OptPtr"));
         { Vector realrule=rule; rule=new Vector<Type>();  realrule.add(new RelElement('^',"Class",(Type)rule.get(0))); rule=realrule; }
