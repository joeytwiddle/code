...
;;Translate==http://translate.google.com/translate_t#auto|en|{searchTerms}",
    ...
    style: "#ddg_extented { float:left; width:100%; position:relative; top:0px; z-index:999 }\
...
#ddg_extented li a:link,li a:visited { text-decoration:none; color:#fff; font-size:1.0em; font-weight:700; padding:0 9px }\
