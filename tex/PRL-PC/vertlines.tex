...
the poor result from the OCR module is not unexpected.
% demonstrates the need for high resolution images.
Better performance can be expected from higher-resolution cameras.
% , controlled lighting conditions, and advances in OCR.
This is demonstrated by the fact that the paragraph in Image {\tt chem017}, a
closer view of a paragraph like those in \reffig{chem015overlay} (not
included here) was recovered with 100\% accuracy.
