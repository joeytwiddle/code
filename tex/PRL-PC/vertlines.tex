...
However, this fitting is only applicable to the ideal paragraph described above.
...
\begin{center}
	...
	\subfigure[Line position gives a poor fitting due to the presence of an outlier.]{
...
\refeqn{spacingsvweqn} to find the altitude of the horizon, $y(\infty)=UV/W$.
% 
% \begin{equation}
% y(\infty) = UV/W
% \end{equation}
