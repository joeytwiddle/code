...
The knowledge of the image pixel values is projected as a grid onto the document plane.  The square pixels in the image project as quadrilaterals onto the document.  Bi-cubic interpolation between these point is arguably overkill.
