...
\reffig{zyspacings}.  Henceforth, we may disregard the $x$-coordinates and deal
...
For example, in \reffig{poorfitting}, data point 7 is an undesirable outlier
...
Once optimised, $V$ and $W$ are plugged into \refeqn{spacingsvweqn} to find the altitude of the horizon $y(\infty) = UV/W$.
...
justified. Finally, \reffig{vvpaccuracyd} displays a further example of the
