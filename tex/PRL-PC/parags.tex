...
\subfigure[The running example.]{\epsfig{figure=images/prlrunning/origover.eps,width=64mm}\label{chem002overlay}\label{summaryfiga}}
\hspace{2mm}
...
\reffig{summaryfiga} shows the line $F_L$ passing through the left margin of
