...
in \reffig{projprofs}).  Unlike $s$ in (\ref{classicproj}), it can be seen that
...
\subfigure[Left justified with extranneouselements]
{\epsfig{figure=images/simulated-left-more.ps,width=34mm}\label{simulated-left-more}} 
\end{center}
\vspace*{0mm}
...
numerical analysis of the performance is given in \reftab{accuracytable} and
