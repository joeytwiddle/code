...
\subfigure[Centrally justified with separated paragraphs]{\epsfig{figure=images/simulated-cen2.ps,width=34mm}\label{simulated-left-more}}
\end{center}
\vspace*{-3mm}
...
To assess the performance of the algorithm, simulated images (such as in \reffig{simimages}) were generated at various orientations ranging from $0^\circ$ to $90^\circ$ in both yaw and pitch, resulting in 900 test images.
...
\centering
\begin{center}
  \epsfig{figure=images/zyspacings9.eps,width=85mm}
...
% To fit the points to the curve in {\em line number}$\times${\em position} space would be unwise in this situation.
% It is preferable to perform the fitting in the {\em line position}$\times${\em line spacing} domain, defined by:
