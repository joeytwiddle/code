...
destroy it (or knock it down to normal armor), then it may be restored as
...
function MutatorTakeDamage( out int ActualDamage, Pawn Victim, Pawn InstigatedBy, out Vector HitLocation, out Vector Momentum, name DamageType) {
 ...
 if (bPreventDamageFromFall && DamageType=='Fell') {
  ...
  // Note: This doesn't actively kill the player, it just causes them to
  // receive the damage they would normal receive.
