class FriendlyBotDomination extends BotDomination
...
function PostBeginPlay()
{
	...
	if(!bServerLoaded)
	{
    	...
    	theVizServer.gameClass = "FriendlyBotDomination";
    
		theBotServer = spawn(class'BotServer',self);
    	theBotServer.gameClass = "FriendlyBotDomination";
...
event InitGame( string Options, out string Error )
{
	...
	// DON'T spawn the weird weapons mutator:
	/*
