...
// CONSIDER: what has IDC support done to bLogFakenickers and bBroadcastFakenickers?
...
function Mutate(String str, PlayerPawn Sender) {
 ...
 if ( args[0]~="HELP" ) {
  ...
  Sender.ClientMessage("AutoTeamBalance "$ "1.4e" $" say commands:");
  ...
  Sender.ClientMessage("AutoTeamBalance "$ "1.4e" $" console commands:");
  Sender.ClientMessage("    mutate strengths [extra]"); // also just "strength"
  Sender.ClientMessage("    mutate listmuts"); // also just "strength"
  Sender.ClientMessage("AutoTeamBalance "$ "1.4e" $" semi-admin console commands:");
  if (localPass == "") {
  ...
  if (Sender.bAdmin) {
   Sender.ClientMessage("AutoTeamBalance "$ "1.4e" $" admin-only console commands:");
