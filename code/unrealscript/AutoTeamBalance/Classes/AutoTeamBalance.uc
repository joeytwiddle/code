...
defaultproperties {
  ...
  UnknownStrength=30      // New player records start with an initial strength of avg_score 40 (I changed this to 30 when I started normalising scores)
  ...
  */
  ...
  if (bBroadcastCookies) {
    if (avg_score[i]>previous_average+1) {
      ...
      p.ClientMessage("You earned "$ Int(avg_score[i]-previous_average) $" this game.", 'CriticalEvent', True);
    }
