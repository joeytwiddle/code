// concave, and probably intersciotion not working.
...
void main(int argc,String *argv) {
  ...
  cdclip=a.floatafter("-ed","Maximum end distance of lines",20);
  creepintoline=a.floatafter("-ic","Intersection can creep in this much of a the line",0.1);
  dotabove=a.floatafter("-pd","Parallelity: dot product must be above this",0.5);
  minlen=a.floatafter("-ml","Minimum length of a line",4);
