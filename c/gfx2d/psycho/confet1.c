...
int main(void) {
  ...
  */
  ...
  // 0 Accelerate
  op[0] = 1; damp[0] = .99; force[0] = .002;
  // 1 Velocity
  op[1] = 1; damp[1] = .99; force[1] = .002;
  // 2 Rotation
  op[2] = 0; damp[2] = .99; force[2] = .01;
  // 3 y splurge
  op[3] = 0; damp[3] = .99; force[3] = .001;
  // 4 Dribble
  op[4] = 1; damp[4] = 0; force[4] = .001;
  // 5 x splurge
  op[5] = 0; damp[5] = .99; force[5] = .001;
  op[6]=2;damp[6]=.99;force[6]=.01;
  op[7]=1;damp[7]=.99;force[7]=.01;
  // Dribble
  op[8] = 1; damp[8] = .99; force[8] = .005;
  // Slide
  op[9] = 0; damp[9] = .99; force[9] = .005;
  // xDisplace
  op[10] = 0; damp[10] = .99; force[10] = .005;
  // yDisplace
  op[11] = 0; damp[11] = .99; force[11] = .005;
