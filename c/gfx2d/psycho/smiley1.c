...
//      img.filledcircle(myrnd()*scrwid,myrnd()*scrhei,2+myrnd()*8,myrnd()*255);
      ...
      img->filledpolar(&starpolarfn,myrnd()*scrwid,myrnd()*scrhei,myrnd()*20,myrnd()*2*pi,saw(toff+(float)1/2)*255);
      img->flower(myrnd()*scrwid,myrnd()*scrhei,myrnd()*20,myrnd()*2*pi,saw(toff+(float)5/6)*255,saw(toff+(float)2/3)*255);
