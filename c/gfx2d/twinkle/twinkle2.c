/* Twinkle: moving stars.  Ported from QBasic by Joey.
   Version 1.2.  FF parameters now driven by a
   dampened-walked velocity, making them smoother.

   This code adapted from original program by jwz/jk.
...
void screenhack(Display *dpy, Window window) {
  if (init_twinkle(dpy, window))
    do_twinkle(dpy, window);
}
