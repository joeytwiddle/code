...
void main() {
  ...
  do {
    to->clear(0);
    to->pos[0][0]=from->pos[0][0]*4;
    to->pos[scrwid-1][0]=from->pos[scrwid-1][0]*4;
    to->pos[0][scrhei-1]=from->pos[0][scrhei-1]*4;
    to->pos[scrwid-1][scrhei-1]=from->pos[scrwid-1][scrhei-1]*4;
