#ifndef jfontforrgbmp_C
  #define jfontforrgbmp_C

  #include <jfontforrgbmp.h>
...
// Starts of class FontBit
   ...
   void FontBit::writetojbmp(RGBmp *j,int x,int y,float scale,myRGB c) {
    printf("arse\n");
  }
// End class 
...
// Starts of class FontChar
  ...
  void FontChar::writetojbmp(RGBmp *j,int x,int y,float scale,myRGB c) {
...
// Starts of class FLine
  ...
  void FLine::writetojbmp(RGBmp *j,int x,int y,float scale,myRGB c) {
    if (round)
...
//    printf("new arc %f %f %f %f %f\n",x,y,r,aa,ab);
  ...
  void FArc::writetojbmp(RGBmp *j,int cx,int cy,float scale,myRGB c) {
    bool first=true;
    V2d o,i;
    if (ab<aa)
      ab+=2*pi;
...
// Starts of class JFont
  ...
  void JFont::writechar(String s,RGBmp *j,int x,int y,float scale,myRGB c) {
  ...
  void JFont::writeString(String s,RGBmp *j,int x,int y,float scale,myRGB c) {
  ...
  void JFont::centerString(String s,RGBmp *j,int y,float scale,myRGB c) {
