...
// Starts of class FontBit
   ...
   void FontBit::writetojbmp(Image *j,int x,int y,float scale,Colour c) {
    printf("arse\n");
  }
// End class 
...
// Starts of class FontChar
  ...
  void FontChar::writetojbmp(Image *j,int x,int y,float scale,Colour c) {
...
// Starts of class FLine
  ...
  void FLine::writetojbmp(Image *j,int x,int y,float scale,Colour c) {
    if (round)
...
//    printf("new arc %f %f %f %f %f\n",x,y,r,aa,ab);
   ...
   FArc::FArc(float a,float b,float c,float d,bool r) {
    rounded=false;
    x=a;
    y=b;
    r=c;
...
//    printf("new arc %f %f %f %f %f\n",x,y,r,aa,ab);
  ...
  void FArc::writetojbmp(Image *j,int cx,int cy,float scale,Colour c) {
    bool first=true;
    V2d o,i;
    if (ab<aa)
      ab+=2*pi;
...
/*  void writetojbmp(Image *j,int cx,int cy,float scale,Colour c) {
    bool first=true;
    V2d p,l;
...
// Starts of class JFont
  ...
  void JFont::writechar(String s,Image *j,int x,int y,float scale,Colour c) {
  ...
  void JFont::writeString(String s,Image *j,int x,int y,float scale,Colour c) {
  ...
  void JFont::centerString(String s,Image *j,int y,float scale,Colour c) {
    int x=j->width/2-scale*1.5*(Slen(s)-1)/2.0;
    writeString(s,j,x,y,scale,c);
  }
  void JFont::centerString(String s,Image *j,int cx,int y,float scale,Colour c) {
