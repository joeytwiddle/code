...
// Class declaration of existence: Ori

// Class declaration of existence: Viewpoint

// Class declaration of existence: Plane
...
/* Skipping declared method V3d operator*(float d,V3d v) */

/* Skipping declared method V3d operator*(V3d v,float d) */
...
// Starts of class V3d
  ...
  // Variable declared in .h file
   ...
   V3d::V3d(float u,float v,float w) {
  ...
  bool V3d::operator==(V3d b) {
    return (dist(*this,b)<0.0001);
  }

  bool V3d::equals(V3d b) {
    return ( (*this) == b );
  }
  
  V3d V3d::operator+(myRGB r) {
  ...
  String V3d::toString() {
   ...
   void V3d::print(V3d v) {
    v.print(); 
  }
  
  
   V3d V3d::add(V3d u, V3d v) {
    return V3d(u.x+v.x,u.y+v.y,u.z+v.z); 
  }
  
  
   V3d V3d::mult(float a,V3d v) {
  ...
  void V3d::normalise() {
   ...
   float V3d::dist(V3d u,V3d v) {
    return V3d::mod(V3d::sub(u,v));
  }
  
   int V3d::equal(V3d u,V3d v) {
   ...
   V3d V3d::cross(V3d u,V3d v) { // i x j = k (left handed)
    return V3d(u.y*v.z-u.z*v.y,u.z*v.x-u.x*v.z,u.x*v.y-u.y*v.x);
  }
  
   V3d V3d::normcross(V3d u,V3d v) {
    return V3d::norm(V3d::cross(u,v));
  }
  
   V3d V3d::oldrotate1(V3d v,V3d axis,float ang) {
    float height,rad;
   ...
   V3d V3d::oldrotate(V3d v,V3d axis,float ang) {
    float height,rad;
  ...
  #ifdef ALLEGRO
   V3d V3d::rotatea(V3d v,V3d axis,float ang) {
    MATRIX m;
   ...
   V3d V3d::rotate(V3d v,V3d axis,float ang) {
    Matrix m=Matrix();
    m.makerotation(axis,ang);
    return m*v;
  }
  
  V3d V3d::rotate(V3d axis,float ang) {
    changeto(V3d::rotate(*this,axis,ang));
    return *this;
  }
  
  V3d V3d::rotated(V3d axis,float ang) {
    return V3d::rotate(*this,axis,ang);
  }
  
  #ifdef ALLEGRO
   V3d V3d::rotatelista(List<V3d> l,V3d axis,float ang) {
    MATRIX_f m;
   ...
   V3d V3d::rotatelist(List<V3d> l,V3d axis,float ang) {
    Matrix m=Matrix();
    m.makerotation(axis,ang);
    for (int i=1;i<=l.length();i++) {
      V3d* v=l.p2num(i);
   ...
   V3d V3d::random(float f) {
    return f*random();
  }
  
   V3d V3d::randomvolume() {
    return random()*sqrt(myrnd());
  }
  
   V3d V3d::randomvolume(float f) {
    return f*random()*sqrt(myrnd());
  }
  
  void V3d::changeto(V3d v) {
    x=v.x; y=v.y; z=v.z;
  }
  
  void V3d::setto(V3d v) {
    x=v.x; y=v.y; z=v.z;
  }
  
  void V3d::operator=(V3d v) {
    changeto(v);
  }
  ...
  void V3d::chop(float low,float high) {
    if (x<low)
      x=low;
    if (x>high)
      x=high;
  ...
  /* Skipping declared method  V3d V3d::orientate(V3d v,Ori ori) */

  /* Skipping declared method  V3d V3d::qorientate(V3d v,Ori ori) */

  /* Skipping declared method  V3d V3d::disorientate(V3d v,Ori ori) */

  /* Skipping declared method V3d V3d::orientate(Ori ori) */

  /* Skipping declared method V3d V3d::disorientate(Ori ori) */
  ...
  /* Skipping declared method V3d V3d::orient(Viewpoint) */

  /* Skipping declared method V3d V3d::disorient(Viewpoint) */
