...
class FontBit {
public:
  virtual void writetojbmp(ImageType *j,int x,int y,float scale,ColourType c) {
    printf("arse\n");
  }
};
...
public:
  ...
  void writetojbmp(ImageType *j,int x,int y,float scale,ColourType c) {
...
//    printf("new arc %f %f %f %f %f\n",x,y,r,aa,ab);
  ...
  FArc(float a,float b,float c,float d,bool rr) {
    rounded=false;
    x=a;
    y=b;
    r=c;
...
public:
  ...
  void writechar(String s,ImageType *j,int x,int y,float scale,ColourType c) {
  ...
  void writeString(String s,ImageType *j,int x,int y,float scale,ColourType c) {
  ...
  void centerString(String s,ImageType *j,int y,float scale,ColourType c) {
    int x=j->width/2-scale*1.5*(Slen(s)-1)/2.0;
    writeString(s,j,x,y,scale,c);
  }
  void centerString(String s,ImageType *j,int cx,int y,float scale,ColourType c) {
