...
class FontBit {
public:
  virtual void writetojbmp(Image *j,int x,int y,float scale,Colour c) {
    printf("arse\n");
  }
};
...
public:
  ...
  void writetojbmp(Image *j,int x,int y,float scale,Colour c) {
...
public:
  ...
  void writechar(String s,Image *j,int x,int y,float scale,Colour c) {
  ...
  void writeString(String s,Image *j,int x,int y,float scale,Colour c) {
  ...
  void centerString(String s,Image *j,int y,float scale,Colour c) {
    int x=j->width/2-scale*1.5*(Slen(s)-1)/2.0;
    writeString(s,j,x,y,scale,c);
  }
  void centerString(String s,Image *j,int cx,int y,float scale,Colour c) {
