...
public:
  ...
  void writetomap(Map2d<Object> *j,int x,int y,float scale,Object c) {
    printf("arse\n");
  }
};
...
public:
  ...
  template<class Object>
  void writechar(String s,Map2d<Object> *j,int x,int y,float scale,Object c) {
  ...
  template<class Object>
  void writeString(String s,Map2d<Object> *j,int x,int y,float scale,Object c) {
  ...
  template<class Object>
  void centerString(String s,Map2d<Object> *j,int y,float scale,Object c) {
    int x=j->width/2-scale*1.5*(Slen(s)-1)/2.0;
    writeString(s,j,x,y,scale,c);
  }
  template<class Object>
  void centerString(String s,Map2d<Object> *j,int cx,int y,float scale,Object c) {
