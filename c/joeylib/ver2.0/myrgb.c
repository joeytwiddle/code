...
fillin myRGB myRGB::white=myRGB(1.0,1.0,1.0);
fillin myRGB myRGB::red  =myRGB(1.0,0.0,0.0);
fillin myRGB myRGB::green=myRGB(0.0,1.0,0.0);
fillin myRGB myRGB::blue =myRGB(0.0,0.0,1.0);
fillin myRGB myRGB::yellow=myRGB(1.0,1.0,0.0);
fillin myRGB myRGB::magenta=myRGB(1.0,0.0,1.0);
fillin myRGB myRGB::cyan=myRGB(0.0,1.0,1.0);
fillin myRGB myRGB::black=myRGB(0.0,0.0,0.0);
fillin myRGB myRGB::grey=myRGB(0.5,0.5,0.5);

fillin myRGB myRGB::darkred=myRGB::red.dark();
fillin myRGB myRGB::darkgreen=myRGB::green.dark();
fillin myRGB myRGB::darkblue=myRGB::blue.dark();
fillin myRGB myRGB::darkyellow=myRGB::yellow.dark();
fillin myRGB myRGB::darkmagenta=myRGB::magenta.dark();
fillin myRGB myRGB::darkcyan=myRGB::cyan.dark();
