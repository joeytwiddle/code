...
public:
  ...
  void writechar(String s,JBmp *j,int x,int y,float scale,int c) {
  ...
  void writeString(String s,JBmp *j,int x,int y,float scale,int c) {
  ...
  void centerString(String s,JBmp *j,int y,float scale,int c) {
    int x=j->width/2-scale*1.5*(Slen(s)-1)/2.0;
    writeString(s,j,x,y,scale,c);
  }
  void centerString(String s,JBmp *j,int cx,int y,float scale,int c) {
